...
# php 5.6
yum install -y php56-php-bcmath php56-php-common php56-php-gd php56-php-intl\
...
dnf install -y php73-php-bcmath php73-php-common php73-php-gd php73-php-intl\
